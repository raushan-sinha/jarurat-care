...
export default function PatientCard({ patient }) {
	return (
		<div className="bg-white shadow-md rounded-2xl p-6 flex flex-col items-start hover:shadow-xl transition-all duration-300">
			...
			<Link
				to={`/patients/${patient.id}`} // 👈 dynamic link
				className="mt-auto bg-[#cc0c39] text-white font-semibold px-4 py-2 rounded-lg hover:bg-red-800 transition cursor-pointer text-center w-full"
			>
				View Details
			</Link>
		</div>
